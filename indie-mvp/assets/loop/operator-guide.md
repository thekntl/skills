...
- Review `config.json`; it contains no secrets or placeholders, and `launchMapIssueUrl` identifies the one canonical Product Launch Map issue in this repository.
